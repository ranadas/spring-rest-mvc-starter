...
/**
 *  EnableTransactionManagement :  lets us use @Transactional on any class or method.
 * Created by rdas on 21/03/2015.
 *
 * https://github.com/resilient-data-systems/fast-stateless-api-authentication/blob/master/src/main/java/uk/co/resilientdatasystems/faststatelesapiauth/config/DatabaseConfig.java
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.rdas.core.dao")
...
public class DataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan("com.rdas.core.domain");
